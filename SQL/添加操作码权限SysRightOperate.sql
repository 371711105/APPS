insert into SysRightOperate values ('administratorRoleManageCreate','administratorRoleManage','Create','True')
insert into SysRightOperate values ('administratorRoleManageDelete','administratorRoleManage','Delete','True')
